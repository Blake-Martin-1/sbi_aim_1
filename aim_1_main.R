...
# load model_data_df
full_retro_df <- read.fst(path = "/home/REDACTED_USERNAME/sbi_blake/pre_micro_vps_vitals_11_21_23.fst")
...
# Now add in lab data
retro_labs <- read_csv(file = "/home/REDACTED_USERNAME/sbi_blake/labs_for_comp.csv")
# retro_fio2 <- read_csv(file = "/home/REDACTED_USERNAME/sbi_blake/fio2_data.csv")
...
get_retro_prism <- read.fst(path = "/home/REDACTED_USERNAME/sbi_blake/pre_micro_vps_vitals_11_21_23.fst")
